...
var Updatable = function (_Component) {
  ...
  function Updatable() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref2 = Updatable.__proto__ || Object.getPrototypeOf(Updatable)).call.apply(_ref2, [this].concat(args))), _this), _this.shouldComponentUpdate = isSusSupported ? function () {
      return true;
    } : function (_ref3) {
      var when = _ref3.when;
      return when;
...
exports.useDidRecover = useDidRecover;
